...
const ProjectList = ({ projects }) => {
    ...
    return (
        <div>
            <div id="scrollableContent" style={{ backgroundColor: 'rgba(38,38,38)', padddingLeft: '100px' }}>
            ...
            <div className="d-none d-lg-block" style={{ backgroundColor: 'rgba(38,38,38)', padddingLeft: '100px', fontFamily: 'VT323', overflow: 'hidden' }}>
                <Row style={{ fontSize: 18, textAlign: 'center', paddingBottom: 50 }}>
                    <Col md={{ span: 4, offset: 2 }}>
                        <a href="https://github.com/ScamporrinoAndrea" target="_blank" rel="noopener noreferrer" className="text-decoration-none" style={{ color: 'white' }}>
                            <Button variant='outline-light' className='github-icon clickable' style={{ padding: 20, borderRadius: 10, fontSize: 20, width: 250 }}>
                                <Bounce>
                                    <Tilt>
                                        <Row>
                                            <Col lg={4}>
